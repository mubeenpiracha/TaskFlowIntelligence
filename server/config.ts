...
export const BASE_URL = 'http://cf3428df-04d6-468d-af24-1dd4a587b350-00-3tucxtywmyqog.janeway.replit.dev';
...
export const SESSION_SECRET = process.env.SESSION_SECRET || 'task-flow-session-secret';